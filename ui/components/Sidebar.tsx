...
const NAV = [
  ...
  { href: "/unlabeled",   label: "Unlabeled",   Icon: UnlabeledIcon },
  { href: "/storage",     label: "Storage",     Icon: StorageIcon },
  { href: "/settings",    label: "Settings",    Icon: SettingsIcon },
  { href: "/access",      label: "Access Token", Icon: AccessIcon },
  { href: "/usecases",    label: "API Docs",    Icon: ApiIcon },
];
  ...
  return (
    <aside className={s.sidebar}>
      <div className={s.logo}>
        <div className={s.logoMark}>MP</div>
        <span className={s.logoText}>MPMedia</span>
      </div>
      <nav className={s.nav}>
      ...
      <div className={s.footer}>
        <div className={s.signedIn}>Signed in as admin</div>
